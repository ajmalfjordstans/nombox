  ...
  return (
    <div className="bg-[#F8FBFF]">
      <div className="container mx-auto pt-[60px] pb-[80px] px-[5%] xl:px-0 flex flex-col items-center">
        <span className="text-[18px] md:text-[24px] font-[600] text-[#2E266F]">Transparent fees, Direct payment</span>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 w-full mt-[40px] md:mt-[67px] gap-[34px]">
          <div className="flex flex-col items-center gap-3 mx-auto w-full max-w-[235px] text-center">
            <img src="/logo/paymentfeatures1.svg" alt="" className="h-[80px] md:h-[120px]" />
            <span className="text-[16px] md:text-[18px] font-[500] leading-[30px] text-[#2E266F]">Easy direct deposit setup</span>
          ...
          <div className="flex flex-col items-center gap-3 mx-auto w-full max-w-[235px] text-center">
            <img src="/logo/paymentfeatures2.svg" alt="" className="h-[80px] md:h-[120px]" />
            <span className="text-[16px] md:text-[18px] font-[500] leading-[30px] text-[#2E266F]">No joining fee or hosting fee </span>
          ...
          <div className="flex flex-col items-center gap-3 mx-auto w-full max-w-[235px] text-center">
            <img src="/logo/paymentfeatures3.svg" alt="" className="h-[80px] md:h-[120px]" />
            <span className="text-[16px] md:text-[18px] font-[500] leading-[30px] text-[#2E266F]">We only make money if you make money</span>
          ...
          <div className="flex flex-col items-center gap-3 mx-auto w-full max-w-[235px] text-center">
            <img src="/logo/paymentfeatures4.svg" alt="" className="h-[80px] md:h-[120px]" />
            <span className="text-[16px] md:text-[18px] font-[500] leading-[30px] text-[#2E266F]">Get paid on every week</span>
