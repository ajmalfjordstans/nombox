  ...
  return (
    <div className='w-full shadow-custom rounded-[16px] bg-white'>
      <Accordion open={open === 'profile'} className=' border-b-[1px] border-[#F2F2F2]'>
        <AccordionHeader onClick={() => handleOpen('profile')} className='border-none shadow-custom p-[10px] md:p-[30px] rounded-[16px]'>
          <div className=' flex justify-between w-full'>
            ...
            <div className='flex items-center justify-end gap-[15px]'>
              <p className='font-[600] text-[16px] leading-[22px] text-[#707070]'>2 Steps remaing</p>
