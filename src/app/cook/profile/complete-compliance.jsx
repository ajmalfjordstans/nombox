  ...
  return (
    <div className='w-full shadow-custom rounded-[16px] bg-white'>
      <Accordion open={open === 'compliance'} className=' border-b-[1px] border-[#F2F2F2]'>
        <AccordionHeader onClick={() => handleOpen('compliance')} className='border-none shadow-custom p-[20px] md:p-[30px] rounded-[16px]'>
          <div className=' flex justify-between w-full'>
            ...
            <div className='flex items-center justify-end gap-[15px]'>
              <p className='font-[600] text-[16px] leading-[22px] text-[#707070] hidden md:block'>4 Steps remaing</p>
        ...
        <AccordionBody className='md:px-[35px] p-[10px] md:p-[30px]'>
          ...
          <Accordion open={tab === 3} icon={<Icon id={3} open={tab} />} className='border-b-[1px] border-[#F2F2F2]'>
            <AccordionHeader onClick={() => handleOpenTab(3)} className='md:px-[35px] p-[20px] md:p-[30px] border-none'>
              <div className='flex gap-[10px] md:gap-[30px] items-center'>
                <div className='h-[24px] w-[24px] md:h-[36px] md:w-[36px] bg-primary rounded-full flex justify-center items-center font-[700] text-[14px] md:text-[18px] leading-[27px] text-white'>
                  3
                </div>
          ...
          <Accordion open={tab === 4} icon={<Icon id={4} open={tab} />}>
            <AccordionHeader onClick={() => handleOpenTab(4)} className='md:px-[35px] p-[20px] md:p-[30px] border-none'>
              <div className='flex gap-[10px] md:gap-[30px] items-center'>
                <div className='h-[24px] w-[24px] md:h-[36px] md:w-[36px] bg-primary rounded-full flex justify-center items-center font-[700] text-[14px] md:text-[18px] leading-[27px] text-white'>
                  4
                </div>
