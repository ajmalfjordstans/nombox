...
export default function Delivery({open, setOpen}) {
  ...
  return (
    <div className='w-full shadow-custom rounded-[16px] bg-white'>
      <Accordion open={open === 'delivery'} className=' border-b-[1px] border-[#F2F2F2]'>
        <AccordionHeader onClick={() => handleOpen('delivery')} className='border-none shadow-custom p-[10px] md:p-[30px] rounded-[16px]'>
