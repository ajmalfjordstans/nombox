...
export default function CardOrder() {
  ...
  return (
    <div className='w-full h-[180px] shadow-custom rounded-[10px] border-[1px] border-[#F2F2F2] bg-white p-[10px] flex gap-[10px] md:gap-[25px]'>
      <Image
      ...
      <div className='w-[100%]'>
        ...
        <div className='flex items-center gap-[10px] lg:gap-[30px] pt-[10px] flex-wrap'>
